    ...
    <View style={{ width: size, height: size, alignItems: 'center', justifyContent: 'center' }}>
      ...
      <View
        style={[
          ...
          Platform.select({
            web: {
              backgroundImage: `conic-gradient(${ACCENT} 0deg, ${CYAN} ${deg}deg, ${track} ${deg}deg 360deg)`,
            } as any,
            default: {
              borderWidth: ring,
              borderColor: track,
              ...
              borderBottomColor: progress >= 0.5 ? CYAN : track,
              borderLeftColor: progress >= 0.75 ? CYAN : track,
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
          ...
          {timerSegments.map((seg, i) => (
            <React.Fragment key={i}>
              ...
              <View style={s.timerSeg}>
                <Text style={[s.timerValue, { color: i === 0 ? ACCENT : colors.text }]}>
        ...
        {nextMs && (
          <View style={[s.milestoneCard, card]}>
            ...
            <View style={s.milestoneRow}>
              <View style={[s.milestoneIconWrap, { backgroundColor: ACCENT + (isDark ? '22' : '14') }]}>
                <Ionicons name={nextMs.icon as any} size={22} color={ACCENT} />
              </View>
        ...
        <View style={s.badgeHeader}>
          ...
          <Text style={[s.badgeCounter, { color: ACCENT }]}>{earnedBadges}/{BADGES.length}</Text>
        </View>
            ...
            return (
              <View key={badge.id} style={s.badgeItem}>
                <View style={[
                  s.badgeCircle,
                  earned
                    ? { backgroundColor: ACCENT + (isDark ? '22' : '14'), borderColor: ACCENT + '66' }
        ...
        <View style={[s.quoteCard, card]}>
          ...
          <Ionicons name="sparkles" size={16} color={ACCENT} style={{ marginBottom: 8 }} />
...
const s = StyleSheet.create({
  ...
  greeting: { fontSize: 24, fontWeight: '800', letterSpacing: -0.5, marginTop: 5 },
  ...
  // Timer pill
  timerCard: { flexDirection: 'row', alignItems: 'center', borderRadius: 20, paddingVertical: 16, paddingHorizontal: 8 },
  ...
  statCard: { flex: 1, minWidth: '45%', borderRadius: 20, padding: 16 },
  ...
  // Milestone
  milestoneCard: { borderRadius: 20, padding: 18, marginTop: 28 },
  ...
  cravingBtn: {
    ...
    ...Platform.select({
      web: { backgroundImage: 'linear-gradient(135deg, #7C3AED, #8B5CF6)', boxShadow: '0 8px 24px rgba(124,58,237,0.4)' } as any,
      default: { backgroundColor: '#7C3AED', shadowColor: '#7C3AED', shadowOpacity: 0.4, shadowRadius: 14, shadowOffset: { width: 0, height: 8 }, elevation: 6 },
    }),
  },
  ...
  // Quote
  quoteCard: { borderRadius: 20, padding: 20, marginTop: 28, overflow: 'hidden' },
  quoteAccent: {
    position: 'absolute', left: 0, top: 0, bottom: 0, width: 4,
    ...Platform.select({
      web: { backgroundImage: 'linear-gradient(180deg, #8B5CF6, #06B6D4)' } as any,
      default: { backgroundColor: ACCENT },
    }),
  },
