...
const TR = {
  ...
  loginSubtitle: 'Yolculuğuna kaldığın yerden devam et',
  registerSubtitle: 'Sigarasız hayata ilk adımı at',
  email: 'E-posta',
  password: 'Şifre',
  fullName: 'Ad Soyad',
  show: 'Göster',
  ...
  authLegalIntro: 'Giriş yaparak',
  authHeadline: 'Sigarasız hayata ilk adım',
  authValue1: 'Türkçe, ücretsiz, gerçekten çalışan',
  authValue2: 'Sana özel bilimsel bırakma planı',
  authValue3: 'Zor anda 7/24 yanında: SOS & ALO 171',
  authTrust: 'KVKK uyumlu · Ücretsiz · Reklamsız',
  or: 'veya',
...
const EN: typeof TR = {
  ...
  loginSubtitle: 'Continue your journey where you left off',
  registerSubtitle: 'Take your first step to a smoke-free life',
  email: 'Email',
  password: 'Password',
  fullName: 'Full Name',
  show: 'Show',
  ...
  authLegalIntro: 'By signing in,',
  authHeadline: 'Your first step, smoke-free',
  authValue1: 'Turkish, free, and it actually works',
  authValue2: 'A science-based plan made for you',
  authValue3: '24/7 support when it’s hard: SOS & helpline',
  authTrust: 'KVKK compliant · Free · No ads',
  or: 'or',
