...
const TR = {
  ...
  deleteAccountWarning: 'Bu işlem geri alınamaz. Tüm yolculuk verilerin, kayıtların ve hesabın kalıcı olarak silinecek.',
...
const EN: typeof TR = {
  ...
  deleteAccountWarning: 'This action cannot be undone. All your journey data, logs and account will be permanently deleted.',
